...
(function (factory) {
    ...
    var pluginName = 'bootstrapDualListbox',
        defaults = {
            ...
            infoText: 'Cantidad Archivos {0}',                                                        // text when all options are visible / false for no info text
            infoTextFiltered: '<span class="badge badge-warning">Filtro</span> {0} de {1}', // when not all of the options are visible due to the filter
    ...
    BootstrapDualListbox.prototype = {
        init: function () {
            ...
            this.container = $('' +
                ...
                '     <button type="button" class="btn moveall"></button><br/>' +
                ...
                '   <input class="form-control filter" type="text">' +
                '   <div class="btn-group buttons">' +
                '     <button type="button" class="btn remove"></button><br/>' +
