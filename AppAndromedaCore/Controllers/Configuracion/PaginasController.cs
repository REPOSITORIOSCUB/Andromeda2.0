...
namespace AppAndromedaCore.Controllers
{
    ...
    {
        RepositorioPagina _repositorioPagina;
        ...
        public ActionResult Index()
        {
            if (verificarSession())
            {
                ...
                return View(_repositorioPagina.getobj());
        ...
        public ActionResult Create()
        {
            if (verificarSession())
            {
                PaginaModel datos = new PaginaModel();
        ...
        // POST: Paginas/Create
        [HttpPost]
        public ActionResult Create(PaginaModel pagina)
        {
            if (verificarSession())
            {
                int mensajesVista = 0;
                ...
                try
                {
                    if (_repositorioPagina.ValidarCampos(pagina, "save"))
                    {
                        if (_repositorioPagina.Create(pagina))
                        {
                            mensajesVista = 1;
                        }
                        else
        ...
        public ActionResult Edit(string id)
        {
            if (verificarSession())
            {
                ...
                PaginaModel tabusu = new PaginaModel();                

                if (id != null)
                {
                    tabusu = _repositorioPagina.FindId(id);
                }
                ...
                if (tabusu != null)
                {
                    ...
                    ViewBag.ListaLogueo = new SelectList(lstlogin.ToList(), "Value", "Text", tabusu.linkExterno);
                    //----------------------
                    return View(tabusu);
                }
                else
        ...
        // POST: Paginas/Edit/5
        [HttpPost]
        public ActionResult Edit(PaginaModel pagina)
        {
            if (verificarSession())
            {
                MensajesOperacion mensajes = new MensajesOperacion();
                ...
                try
                {
                    ...
                    if (_repositorioPagina.ValidarCampos(pagina, "edit"))
                    {
                        if (_repositorioPagina.Edit(pagina))
                        {
                            mensajesVista = 6;
                        }
                    }
        ...
        public ActionResult Delete(string id)
        {
            if (verificarSession())
            {
                ...
                if (id != null)
                {
                    ...
                    Datos = _repositorioPagina.FindId(id);
                    return View(Datos);
                }
                else
                {
        ...
        [HttpPost]
        public ActionResult Delete(PaginaModel pagina)
        {
            if (verificarSession())
            {
                MensajesOperacion mensajes = new MensajesOperacion();
                ...
                try
                {
                    ...
                    if (_repositorioPagina.Delete(pagina))
                    {
                        mensajesVista = 9;
                    }
                    else
