    ...
    public class TipoUsuariosController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (verificarSession())
            {
                ...
                return View(_repositorioTipoUsuario.getobj());
        ...
        {
            if (verificarSession()) {
                TipoUsuarioModel datos = new TipoUsuarioModel();
                return View(datos);
            }
            else
            {
        ...
        [HttpPost]
        public ActionResult Create(TipoUsuarioModel tipousuario)
        {
            verificarSession();
            ...
            try
            {
                if (_repositorioTipoUsuario.ValidarCampos(tipousuario, "save"))
                {
                    if (_repositorioTipoUsuario.Create(tipousuario))
                    {
                        mensajesVista = 1;
                    }
                    else
        ...
        public ActionResult Edit(string id)
        {
            if (verificarSession())
            {
                ...
                TipoUsuarioModel tabusu = new TipoUsuarioModel();

                if (id != null)
                {
                    tabusu = _repositorioTipoUsuario.FindId(id);
                }
        ...
        [HttpPost]
        public ActionResult Edit(TipoUsuarioModel tipousuario)
        {
            if (verificarSession())
            {
                MensajesOperacion mensajes = new MensajesOperacion();
                ...
                try
                {
                    ...
                    if (_repositorioTipoUsuario.ValidarCampos(tipousuario, "edit"))
                    {
                        if (_repositorioTipoUsuario.Edit(tipousuario))
                        {
                            mensajesVista = 6;
                        }
                    }
        ...
        public ActionResult Delete(string id)
        {
            if (verificarSession())
            {
                ...
                if (id != null)
                {
                    TipoUsuarioModel tipusu = new TipoUsuarioModel();

                    tipusu = _repositorioTipoUsuario.FindId(id);
                    return View(tipusu);
                }
                else
                {
        ...
        public ActionResult DeleteConfirmed(TipoUsuarioModel tipousuario)
        {
            if (verificarSession())
            {
                MensajesOperacion mensajes = new MensajesOperacion();
                ...
                try
                {
                    ...
                    if (_repositorioTipoUsuario.Delete(tipousuario))
                    {
                            mensajesVista = 9;                        
                    }
                    else
